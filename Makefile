...
MAIN_OBJS = main.o
COMMON_OBJS = error.o debug.o alloc.o buffer.o network.o
SSH_OBJS = ssh.o ssh_constants.o debug.o hash.o cipher.o mac.o verify.o banner.o stream.o connection.o kex.o kex_dh.o
